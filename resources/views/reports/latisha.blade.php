...
<head>
    ...
    <style>
        ...
        .bluebg {background-color: #48C2C4; color:#fff;padding: 5px;height: 150px;border-left: 5px solid #fff;border-right: 5px solid #fff;margin-top:5rem;}
    ...
    <div class="container-fluid" style="background-color: #48C2C5; padding:0;">
        ...
        <div class="col-md-9" style="background-color: rgb(255,255,255); text-align: center;">
            ...
            <div class="row">
                <div class="col-md-2">
                    <figure>
                        <img src="{{ asset('images/Samantha_Brown.png') }}" alt="" style="max-width: 100%">
                    </figure>
                </div>
                <div class="col-md-3">
                    <div class="row">
